<template>
  <div class="container mx-auto mb-6 px-4 sm:px-6 lg:px-8">
    ...
    <div class="prose">
      <p>
        To commit to MPP for 2022, please use the link you received via email.
        If you didn't receive a link, please contact Leah Cooper at
        <a href="mailto:lcooper@mid-city.com">lcooper@mid-city.com</a>. Thank
        you!
      </p>
      ...
      <p>
        Thank you for your consideration, and we look forward to reaching our
        mutual goals together. Please feel free to contact Leah Cooper with any
        questions.
      </p>
    </div>
  </div>
